        ...
        >
          <picture className="block h-full w-full">
            ...
            <img
              ...
              alt="SAPPHIRE campaign editorial"
              width={1376}
              height={768}
              fetchPriority="high"
              loading="eager"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 md:px-14 pb-8 sm:pb-12 lg:pb-14 mt-auto">
          ...
          <div className="lg:col-span-4 lg:pb-2">
            ...
            >
              <p className="text-[11px] sm:text-xs md:text-sm font-sans font-light leading-[1.7] text-[#FAF8F5]/72">
                Architectural drape, sculpted silhouette, and considered
                material — composed with restraint.
              </p>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-4">
                <button
                  ...
                  className="group inline-flex min-h-11 items-center gap-3 border-b border-[#FAF8F5]/35 pb-1.5 text-[10px] sm:text-[11px] tracking-[0.23em] uppercase font-sans text-[#FAF8F5] transition-colors duration-300 hover:border-[#FAF8F5] focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FAF8F5]/70"
                >
                ...
                <button
                  ...
                  className="inline-flex min-h-11 items-center text-[10px] sm:text-[11px] tracking-[0.2em] uppercase font-sans text-[#FAF8F5]/58 transition-colors duration-300 hover:text-[#FAF8F5] focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FAF8F5]/70"
                >
                  The Bag · PKR 8,990
                </button>
              </div>
        ...
        >
          ...
          <button
            ...
            className="group flex min-h-11 items-center gap-2 text-[8px] sm:text-[9px] tracking-[0.28em] uppercase font-sans text-[#FAF8F5]/42 transition-colors duration-300 hover:text-[#FAF8F5] focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FAF8F5]/70"
          >
            <span>Scroll</span>
